...
$btOpenFile = GUICtrlCreateButton("Carregar arquivo LNK", 20, 32, 370, 28)
GUICtrlSetOnEvent(-1, '_btOpenFile')
GUICtrlSetResizing($btOpenFile, $GUI_DOCKLEFT)

$btSaveFile = GUICtrlCreateButton("Salvar arquivo LNK", 410, 34, 370, 28)
...
Func _btBrowseForFile()
	Local $var = FileSaveDialog("Escolha um nome de arquivo LNK", "D:\", "Atalhos LNK (*.lnk)", 2) ; option 2 = dialog remains until valid path/file selected
	If @error Then
